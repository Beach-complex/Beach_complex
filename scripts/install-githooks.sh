...
git update-index --chmod=+x .githooks/pre-commit .githooks/pre-push .githooks/commit-msg || true
chmod +x .githooks/pre-commit .githooks/pre-push .githooks/commit-msg scripts/secret-scan.sh || true
