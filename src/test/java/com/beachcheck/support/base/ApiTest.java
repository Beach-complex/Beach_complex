package com.beachcheck.support.base;

import com.beachcheck.global.security.JwtUtils;
...
/**
 * Why: API (Controller) 테스트 공통 설정 중앙 관리 Policy: MockMvc + 실제 DB + JWT 인증 Contract(Input): 모든 API
 * 테스트 클래스가 이를 상속 Contract(Output): HTTP 요청/응답 테스트 가능
 */
@SpringBootTest
...
public abstract class ApiTest {
  ...
  @Autowired protected MockMvc mockMvc; // HTTP 요청/응답 테스트용

  @Autowired protected ObjectMapper objectMapper; // JSON 직렬화/역직렬화용
