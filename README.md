...
- `docs/` 아래에 협업 규칙, 기술 결정 기록, 트러블슈팅 문서를 정리하고 있습니다.
...
- 프로젝트 문서 홈: [`docs/README.md`](./docs/README.md)
- SSOT 문서: [`docs/ssot.md`](./docs/ssot.md)
- ADR: [`docs/adr/README.md`](./docs/adr/README.md)
- 트러블슈팅 문서: [`docs/troubleshooting/docs-README.md`](./docs/troubleshooting/docs-README.md)
