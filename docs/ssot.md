...
> **목적**: 일관성 있는 코드 작성을 위한 레이어별 책임과 예외 처리 전략 정의
...
| 2026-01-07 | GitHub Copilot | 레이어 아키텍처 & 예외 처리 섹션 추가 (Controller/Service/Domain/Repository 책임 정의, 입력 검증 전략, ApiException 설계) |
